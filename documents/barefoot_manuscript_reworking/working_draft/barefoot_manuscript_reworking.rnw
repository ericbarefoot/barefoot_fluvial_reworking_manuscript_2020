...
opts_chunk$set(fig.path='figures/', fig.align='center', fig.show='hold', echo=FALSE, warning=FALSE, message=FALSE)
...
\pnote[I think this is where we outline a new model for channel geometry and lateral motion across variable flow conditions]

...
%
%  sedimentary basins are the primary archives holding records of paleoenvironmental change , .
%
...
% \pnote[may be worth expanding this bit later.]

\section{Methods}

\subsection{Study Locality}
...
\subsection{Paleohydraulic Techniques}
